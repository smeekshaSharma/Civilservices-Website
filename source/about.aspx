...
&nbsp;</td>
  ...
  <div id="apDiv8">
    <table width="100%" border="0">
      <tr>
        <td><div align="center"><span clAbout Us</span class="style6"><strong>
            <span class="style7">ABOUT Us</span></strong></div></td>
      </tr>
      <tr>
        <td><hr style="background-color: #FFFFFF" /></td>
      </tr>
      <tr>
        <td class="style5">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    <asp:BoundField DataField="atypes" HeaderText="Atypes" 
                        SortExpression="atypes" />
                    <asp:BoundField DataField="cdate" HeaderText="Cdate" SortExpression="cdate" />
                    <asp:BoundField DataField="ades" HeaderText="Ades" SortExpression="ades" />
                    <asp:BoundField DataField="pdfdoc" HeaderText="PDF/DOC" 
                        SortExpression="pdfdoc" />
                </Columns>
            </asp:GridView>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                SelectCommand="SELECT [atypes], [cdate], [ades], [pdfdoc] FROM [aboutus]">
            </asp:SqlDataSource>
          </td>
      </tr>
    </table>
