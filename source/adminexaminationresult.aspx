...
<script runat="server">
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        conn.Open()
        command = New Data.SqlClient.SqlCommand("select count (*) from exam where eni='" & T2.Text & "'")
        command.Connection = conn
        count = command.ExecuteScalar
        If (count > 0) Then
            MsgBox("Examination Result detail already Exist")
            conn.Close()
        Else
            sql = "insert into exam values('" & T1.Text & "','" & T2.Text & "','" & T3.Text & "','" & T4.Text & "','" & T5.Text & "','" & t6.Text & "','" & T7.Text & "','" & T8.Text & "','" & T9.Text & "','" & T10.Text & "','" & T11.Text & "')"
...
<div id="apDiv1">
  ...
  <div id="apDiv3">
    <table width="100%" border="0">
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF" class="style21"><a href="adminrti.aspx" class="style31">RTI</a></td>
      </tr>
      <tr>
  ...
  <div id="apDiv6">
    <table width="100%" border="0">
      <tr>
        <td colspan="2" bgcolor="White"> <div align="left" class="style16">
      ...
      <tr>
        <td colspan="4" bgcolor="#006DF0" class="style33"> <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Examination 
      ...
      <tr>
        <td class="style26">Contact No</td>
        <td colspan="2"><span class="style28">
      ...
      <tr>
        <td class="style26">Date of Birth</td>
        <td colspan="2"><span class="style28">
      ...
      <tr>
        <td class="style26">Candinate Name</td>
        <td colspan="2"><span class="style28">
      ...
      <tr>
        <td colspan="4" bgcolor="#006DF0" class="style26"> Stage 1</td>
        </tr>
      <tr>
...
&nbsp;&nbsp;&nbsp;
      ...
      <tr>
        <td height="150" class="style26">&nbsp;</td>
        <td colspan="2"><span class="style29"></span></td>
        <td>&nbsp;</td>
      </tr>
    </table>
