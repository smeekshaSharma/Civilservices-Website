      ...
      <tr>
        <td>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    <asp:BoundField DataField="cate" HeaderText="Category" 
                        SortExpression="cate" />
                    <asp:BoundField DataField="vac" HeaderText="Vacancy" SortExpression="vac" />
                    <asp:BoundField DataField="minqualsws" HeaderText="Minimum Qualification" 
                        SortExpression="minqualsws" />
                    <asp:BoundField DataField="totalmarksws" HeaderText="Total Marks" 
                        SortExpression="totalmarksws" />
                    <asp:BoundField DataField="cutoffmarksfs" HeaderText="Cut off Marks" 
                        SortExpression="cutoffmarksfs" />
                    <asp:BoundField DataField="totalmarksfs" HeaderText="Total Marks of Final Stage" 
                        SortExpression="totalmarksfs" />
                    <asp:BoundField DataField="pdfdocument" HeaderText="PDF" 
                        SortExpression="pdfdocument" />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                SelectCommand="SELECT [cate], [vac], [minqualsws], [totalmarksws], [cutoffmarksfs], [totalmarksfs], [pdfdocument], [state], [city] FROM [cuttoffmarks] WHERE ([ename] = @ename)">
                <SelectParameters>
                    <asp:ControlParameter ControlID="DropDownList1" Name="ename" 
