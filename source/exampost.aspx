        ...
        <tr>
          <td><marquee direction="up"height="374px"width="336px"scrollamount="3">
              <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                  DataSourceID="SqlDataSource4" Width="100%" GridLines="None">
                  <Columns>
    ...
    <table width="100%" border="0">
      <tr>
        <td><div align="center" class="style7">
            <strong style="coExam Post</strong></div></td>
      </tr>
      <tr>
        <td><hr /></td>
      </tr>
      <tr>
        <td>
            Exam Name<asp:DropDownList 
                ID="D3" runat="server" DataSourceID="SqlDataSource2" DataTextField="examname" 
      ...
      <tr>
        <td>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                DataSourceID="SqlDataSource1" Width="50%">
                <Columns>
                    <asp:BoundField DataField="examname" HeaderText="Examination Name" 
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                SelectCommand="SELECT [examname], [postname] FROM [post] WHERE ([examname] = @examname)">
                <SelectParameters>
