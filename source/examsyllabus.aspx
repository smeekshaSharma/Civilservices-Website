...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','960','height','412','src','../animation/Movie2','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','../animation/Movie2' ); //end AC code
        ...
        <tr>
          <td><marquee direction="up"height="374px"width="336px"scrollamount="3">
              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                  DataSourceID="SqlDataSource3" Width="100%" GridLines="None">
                  <Columns>
              ...
              <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                  ...
                  SelectCommand="SELECT [nexam] FROM [news]"></asp:SqlDataSource>
          </td>
        </tr>
      </table>
    </div>
  ...
  <div id="apDiv8">
    ...
    <table width="100%" border="0">
      <tr>
        <td><div align="center" class="style5"><strong>Exam Syllabus</strong></div></td>
      </tr>
      <tr>
        <td><hr /></td>
      </tr>
      <tr>
        <td>
            Exam Name<asp:DropDownList 
                ID="DropDownList1" runat="server" AutoPostBack="True" 
                DataSourceID="SqlDataSource2" DataTextField="examname" 
                DataValueField="examname">
            </asp:DropDownList>
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                
                SelectCommand="SELECT [examname], [dateofexam], [duration], [lastdate], [notification] FROM [examnotice]"></asp:SqlDataSource>
          </td>
      </tr>
      <tr>
        <td>
            ...
            <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" 
                ...
                <Fields>
                    ...
                    <asp:BoundField DataField="subname1" HeaderText="Subject1" 
                        SortExpression="subname1" />
                    <asp:BoundField DataField="dur" HeaderText="Duration" 
                        SortExpression="dur" />
                    <asp:BoundField DataField="pdf1" HeaderText="PDF Download" 
                        SortExpression="pdf1" />
                    <asp:BoundField DataField="subname2" HeaderText="Subject2" 
                        SortExpression="subname2" />
                    <asp:BoundField DataField="pdf2" HeaderText="PDF Download" 
                        SortExpression="pdf2" />
                    <asp:BoundField DataField="subname3" HeaderText="Subject3" 
                        SortExpression="subname3" />
                    <asp:BoundField DataField="dur3" HeaderText="Duration" 
                        SortExpression="dur3" />
                    <asp:BoundField DataField="pdf3" HeaderText="PDF Download" 
                        SortExpression="pdf3" />
                    <asp:BoundField DataField="subname4" HeaderText="Subject4" 
                        SortExpression="subname4" />
                    <asp:BoundField DataField="dur4" HeaderText="Duration" 
                        SortExpression="dur4" />
                    <asp:BoundField DataField="pdf4" HeaderText="PDF Download" 
                        SortExpression="pdf4" />
                    <asp:BoundField DataField="subname5" HeaderText="Subject5" 
                        SortExpression="subname5" />
                    <asp:BoundField DataField="dur5" HeaderText="Duration" 
                        SortExpression="dur5" />
                    <asp:BoundField DataField="pdf5" HeaderText="PDF Download" 
                        SortExpression="pdf5" />
                </Fields>
            </asp:DetailsView>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                SelectCommand="SELECT [postname], [cyear], [subname1], [dur], [pdf1], [subname2], [pdf2], [subname3], [dur3], [pdf3], [subname4], [dur4], [pdf4], [subname5], [dur5], [dur2], [pdf5] FROM [examsly] WHERE ([examname] = @examname)">
                <SelectParameters>
                    <asp:ControlParameter ControlID="DropDownList1" Name="examname" 
