...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','960','height','412','src','../animation/Movie2','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','../animation/Movie2' ); //end AC code
    ...
    <div id="apDiv7">
      <table width="100%" border="0">
        <tr>
          ...
          <td width="96%"><span class="style4"> <marquee direction="left">Civil Services (Preliminary) Examination, 2020: Last date for Online submission of application is 03.03.2020, 6.00 PM     </span></td>
        </tr>
      </table>
    </div>
    <div id="apDiv9">
  ...
  <div id="apDiv8">
    <table width="100%" border="0">
      <tr>
        <td style="color: #2B5277; font-weight: 700" class="style6" colspan="2">
      ...
      <tr>
        <td colspan="2">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                SelectCommand="SELECT [que], [ans] FROM [FAQ] WHERE ([Faqtype] = @Faqtype)">
                <SelectParameters>
                    <asp:ControlParameter ControlID="DropDownList1" Name="Faqtype" 
