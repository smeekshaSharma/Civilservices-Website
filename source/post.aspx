    ...
    <div id="apDiv7">
      <table width="100%" border="0">
        <tr>
          ...
          <td width="96%"><span class="style4"> <marquee direction="left">Civil Services (Preliminary) Examination, 2020: Last date for Online submission of application is 03.03.2020, 6.00 PM    </marquee><table 
                  width="100%" border="0" style="height: 408px">
        <tr>
...
&nbsp;</td>
  ...
  <div id="apDiv8">
    <table width="100%" border="0">
      <tr>
        <td colspan="2"><div align="center"><strong> Post detail&nbsp;</strong></div></td>
      </tr>
      <tr>
      ...
      <tr>
        <td width="11%" height="24"><strong>Examination Name&nbsp;&nbsp;</strong></td>
        <td width="89%"><asp:DropDownList ID="DropDownList1" runat="server" 
                AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="examname" 
      ...
      <tr>
        <td height="31" colspan="2">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                DataSourceID="SqlDataSource3" Width="99%" Height="146px">
                <Columns>
            ...
            <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                SelectCommand="SELECT [examname], [postname], [cyear] FROM [post] WHERE ([examname] = @examname)">
                <SelectParameters>
